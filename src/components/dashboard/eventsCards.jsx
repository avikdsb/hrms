  ...
  return (
    <div className="flex flex-col justify-start items-start gap-5 p-[1rem] rounded-2xl ">
      ...
      <div className="flex flex-col justify-start items-start gap-5 ml-5">
        <div
          className={`flex flex-row justify-start gap-3 text-${styles.eventDateSize} font-subtitle`}
        >
        ...
        <div
          className={`flex flex-row justify-start gap-3 text-${styles.eventLocationSize} font-subtitle gap-3`}
        >
