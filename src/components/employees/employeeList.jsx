...
const EmployeeList = ({ newEmployeesData }) => {
  // Combine initial assets data with new uploaded data
  const combinedEmployeesData = [
    ...initialEmployeesData,
    ...newEmployeesData.filter(
      (newEmployee) =>
        !initialEmployeesData.some(
          (initialEmployee) => initialEmployee.empId === newEmployee.empId
        )
    ),
  ];
  console.log("Combined Assets Data:", combinedEmployeesData);
  ...
  const columns = [
    ...
    { field: "empEmail", headerName: "Email ID", flex: 1 },
    { field: "empPermanentAddress", headerName: "Permanent Address", flex: 1 },
    { field: "empCurrentAddress", headerName: "Current Address", flex: 1 },
    { field: "empAadhaarId", headerName: "Aadhaar ID", flex: 1 },
    { field: "empPanId", headerName: "Pan ID", flex: 1 },
    { field: "empDob", headerName: "D.O.B.", flex: 1 },
    { field: "empDoj", headerName: "D.O.J.", flex: 1 },

    { field: "empDepartment", headerName: "Department", flex: 1 },
    { field: "empDesignation", headerName: "Designation", flex: 1 },
    { field: "empGrade", headerName: "Grade", flex: 1 },
    {
      field: "empRole",
      headerName: "Role",
      flex: 1,
    ...
    { field: "empReporting1", headerName: "Reporting 1", flex: 1 },
    { field: "empReporting2", headerName: "Reporting 2", flex: 1 },
    { field: "empAssets", headerName: "Asset ID", flex: 1 },
    {
      field: "empStatus",
      headerName: "Status",
      flex: 1,
